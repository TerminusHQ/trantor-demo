...
@FunctionImpl(name = "middle positionType staff function impl")
public class StaffMiddlePositionTypeFuncImpl implements StaffPositionTypeFunc {
    @Override
    public void execute(Staff staff) {
        log.info("outstanding staff: {}", staff.getStaffName());
    }
}
